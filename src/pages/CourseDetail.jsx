  ...
  return (
    <>
      {status === STATUSES.IDLE && (
        <div className="lg:mx-44 xl:mx-64">
          <div className="px-4 py-4 flex flex-col gap-3 font-plusSans pt-10">
            <h1 className="text-3xl font-semibold mb-3 mt-2 font-montserrat xl:text-4xl xl:font-bold">
              {course?.name}
            </h1>
            ...
            <button
              className="p-4 mb-4 bg-cyan-500 border border-black mx-auto rounded-md text-white font-semibold font-montserrat w-2/3 mt-4 hover:bg-cyan-600 transition-all duration-300 ease-in-out xl:w-1/4 xl:mt-8"
